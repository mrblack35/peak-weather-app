...
function forecastList(data) {
    ...
    for(const entry of entries) {
        //let arrEntries = Object.entries(entry[1]);
        //console.log(entry[1]);
        const reportList = document.createElement('div');
        reportList.className = "report";
        ...
        for (const [key, value] of Object.entries(forecastDetails)) {
            ...
            if (key == "high") {
                const wValueSpan = document.createElement('span');
                //wValueSpan.innerHTML = `${value}<sup>\u00B0${tUnit}</sup>`;
                ...
                //wValueSpan.innerHTML = `Feels like ${value}<sup>\u00B0${tUnit}</sup>`;
                wValueDiv.append(wValueSpan);
            } else if (key == "expectedRainfall") {
                const wValueSpan = document.createElement('span');
                wValueSpan.innerText = `Rainfall ${value} mm`;
                //wValueSpan.innerText = `Rainfall ${Math.ceil(value * 25.4)} mm`;
                wValueDiv.append(wValueSpan);
            } else if (key == "expectedSnowfall") {
                const wValueSpan = document.createElement('span');
                wValueSpan.innerText = `Snowfall ${value} cm`;
                //wValueSpan.innerText = `Snowfall ${Math.ceil(value * 2.54)} cm`;
                wValueDiv.append(wValueSpan);
            } else if (key == "weatherConditions") {
                const weatherText = value.replace("shwrs","showers").replace("mod.","moderate");
        ...
        //iterate over object values and assign to a span. Use index to exclude last two values
        //const valueDiv = document.createElement('div');
        //valueDiv.className = "tempFall";

        //for (const [index, [key, value]] of Object.entries(Object.entries(forecastDetails))) {
            //if (index < 5) {
                //const valueSpan = document.createElement('span');
                //valueSpan.innerText = value;
                //console.log(`${index} ${value}`);
                //addValueSpan (valueSpan);
            //}
        //}
        //function addValueSpan (valueSpan) {
            //valueDiv.append(valueSpan);
        //}
        
        //reportList.append(valueDiv);
        ...
        function weatherCondition (weatherText) {
            ...
            //weatherIcon.style = "max-width: 9rem;";
        ...
        function windCondition (windConText) {
            ...
            function arrowDirection (windDirection, speedInMph, windArrow) {
                ...
                windArrow.style = `transform-origin:50% 50%; transform: rotate(${angle}deg); width: 1.4rem`;
